...
* **📊 İnteraktif Veri Yönetimi:** Dinamik tablolar üzerinden tek tıkla başvuru ekleme, silme ve durum güncelleme yapılabilir ve filtreleme özelliği sayesinde başvurular daha kolay aranabilir.
...
* **Pandas** (Veri Analizi ve Tablo Yönetimi)
* **Plotly** (Veri Görselleştirme)

## 📌 Geliştirici Notu
Bu proje, veri gizliliği standartlarına uygun olarak tasarlanmıştır. Canlı demoda güvenlik sebebiyle varsayılan veritabanı boş gelmektedir. Kendi bilgisayarınızda (Lokalde) tam performansla kullanmak için repoyu klonlayıp çalıştırabilirsiniz.